function varargout=flvoice_dirtree(varargin)
% [sub,ses,run] = flvoice_dirtree

if flvoice('remote'), [varargout{1:nargout}]=conn_server('run',mfilename,varargin{:}); return; end
